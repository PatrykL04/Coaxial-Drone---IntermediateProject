...
Unlike traditional quadcopters, this drone operates as a "SingleCopter". The design relies on a modular outer duct and a central core (torpedo) that houses all electronics and the power supply. The geometry is optimized to ensure a perfect Center of Gravity (CG) and stable airflow.
...
* **Active Thrust Vectoring:** Four independently controlled paddles (vanes) at the bottom of the duct provide full 3-axis control.
